...
public class TomlFileConfig {
    ...
    public static Object normalizeForToml(Object value) {
        ...
        // NightConfig's own Config/CommentedConfig â€” preserve structure but normalize contents
        ...
        // Handle Lists â€” recurse into each element, filtering out null/unsupported items
        ...
        // Enums â€” serialize as their name string
    ...
    private static class TomlConfigWrapper implements CommentedFileConfig {
        ...
        @Override
        public <R> R bulkCommentedRead(
            final java.util.function.Function<? super com.electronwill.nightconfig.core.UnmodifiableCommentedConfig, R> action
        ) {
            return delegate.bulkCommentedRead(action);
        }

        @Override
        public <R> R bulkCommentedUpdate(
            final java.util.function.Function<? super com.electronwill.nightconfig.core.CommentedConfig, R> action
        ) {
            return delegate.bulkCommentedUpdate(action);
        }

        @Override
        public <R> R bulkUpdate(final java.util.function.Function<? super com.electronwill.nightconfig.core.Config, R> action) {
            return delegate.bulkUpdate(action);
        }
