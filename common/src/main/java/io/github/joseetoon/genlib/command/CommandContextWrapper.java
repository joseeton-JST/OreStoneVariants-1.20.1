...
import io.github.joseetoon.genlib.client.ClientScreenSetter;
...
import io.github.joseetoon.genlib.exception.CommandExecutionException;
...
import static io.github.joseetoon.genlib.exception.Exceptions.cmdEx;
...
public class CommandContextWrapper {
    ...
    public PendingMessageWrapper generateMessage(final String msg, final Style style) {
        return new PendingMessageWrapper(this, (MutableComponent) Component.literal(msg).setStyle(style));
    }
    ...
    public void setScreen(final Object screen) {
        ClientScreenSetter.setScreen(screen);
    }
    ...
    public Result<Integer, CommandExecutionException> tryExecute(final String command) {
        ...
        try {
            ...
            return Result.err(new CommandExecutionException(e));
        }
    }
