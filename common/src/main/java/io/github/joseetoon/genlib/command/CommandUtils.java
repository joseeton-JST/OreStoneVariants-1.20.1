...
import static io.github.joseetoon.genlib.command.CommandSuggestions.ANY_INT;
import static io.github.joseetoon.genlib.command.CommandSuggestions.ANY_DECIMAL;
...
public class CommandUtils {
     ...
     * @return An argument builder for the given specs.
     */
    public static RequiredArgumentBuilder<CommandSourceStack, BlockInput> blkArg(final String name, final CommandBuildContext ctx) {
     ...
     */
    public static HoverEvent displayOnHover(final MutableComponent txt) {
