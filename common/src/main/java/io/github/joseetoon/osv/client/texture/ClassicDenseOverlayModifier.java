...
public class ClassicDenseOverlayModifier implements OverlayModifier {

    public static final ClassicDenseOverlayModifier INSTANCE = new ClassicDenseOverlayModifier();

    private ClassicDenseOverlayModifier() {}
