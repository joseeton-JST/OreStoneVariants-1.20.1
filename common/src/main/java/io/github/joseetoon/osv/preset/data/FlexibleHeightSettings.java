...
import io.github.joseetoon.osv.world.providers.SeaLevelVerticalAnchor;
...
public class FlexibleHeightSettings {
    ...
    public static record NamedOffset(String type, Range y) {
        ...
        private static final Codec<NamedOffset> BOTTOM_OR_TOP =
            new SimpleEitherCodec<>(BOTTOM_CODEC, TOP_CODEC)
                .withEncoder(o -> TOP.equals(o.type) ? TOP_CODEC : BOTTOM_CODEC);
        private static final Codec<NamedOffset> ABSOLUTE_OR_SEA =
            new SimpleEitherCodec<>(ABSOLUTE_CODEC, SEA_CODEC)
                .withEncoder(o -> ABSOLUTE.equals(o.type) ? ABSOLUTE_CODEC : SEA_CODEC);

        public static final Codec<NamedOffset> CODEC =
            new SimpleEitherCodec<>(BOTTOM_OR_TOP, ABSOLUTE_OR_SEA)
