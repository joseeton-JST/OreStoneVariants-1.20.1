...
public class DefaultStones {
    ...
    public static final Group[] LISTED = {
        Group.named("biomesoplenty").withEntries("white_sandstone", "orange_sandstone", "black_sandstone").implicitNamespace(),
        ...
        Group.named("regions_unexplored").withEntries("chalk").implicitNamespace()
    };
