...
import io.github.joseetoon.osv.compat.ConfigCompat;
import io.github.joseetoon.osv.exception.PresetSyntaxException;
import io.github.joseetoon.osv.exception.UnavailableConfigException;
...
public class ConfigProvider {
    ...
    public static ConfigFile tryLoad(final File file) {
        ...
        try {
            final JsonObject json = JsonValue.readHjson(contents).asObject();
