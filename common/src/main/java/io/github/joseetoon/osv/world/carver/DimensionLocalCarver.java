...
public class DimensionLocalCarver extends WorldCarver<DimensionLocalCarverConfig> {
    ...
    @Override
    public boolean carve(CarvingContext ctx, DimensionLocalCarverConfig cfg, ChunkAccess chunk, Function<BlockPos, Holder<Biome>> biomes, RandomSource rand, Aquifer aquifer, ChunkPos pos, CarvingMask mask) {
    ...
    @Override
    public boolean isStartChunk(DimensionLocalCarverConfig cfg, RandomSource rand) {
        return true;
    }
}