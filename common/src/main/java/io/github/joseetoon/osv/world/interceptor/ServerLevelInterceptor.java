...
import io.github.joseetoon.osv.mixin.EntityAccessor;
import io.github.joseetoon.osv.mixin.FallingBlockEntityAccessor;
import io.github.joseetoon.osv.mixin.MobAccessor;
...
public class ServerLevelInterceptor extends ServerLevel implements InterceptorAccessor {
    ...
    static ServerLevelInterceptor create(final ServerLevel level) {
        ...
        interceptor.tickInterceptor = new ServerTickInterceptor(interceptor, level.getBlockTicks());
        return interceptor;
    }
    ...
    public boolean addFreshEntity(final Entity entity) {
        final ServerLevel level = this.getWrapped();
        ((EntityAccessor) entity).osv$setLevel(level);
