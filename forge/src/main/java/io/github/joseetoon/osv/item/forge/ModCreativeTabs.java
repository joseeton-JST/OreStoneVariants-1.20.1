...
public class ModCreativeTabs {
    ...
    // DeferredRegister.create — ResourceLocation constructors are never SRG-remapped.
    public static final DeferredRegister<CreativeModeTab> TABS =
        DeferredRegister.<CreativeModeTab>create(
            new ResourceLocation("minecraft", "creative_mode_tab"), Reference.MOD_ID);

    public static final RegistryObject<CreativeModeTab> VARIANT_TAB = TABS.register("variants", () ->
    ...
    public static final RegistryObject<CreativeModeTab> DENSE_VARIANT_TAB = TABS.register("dense_variants", () ->
